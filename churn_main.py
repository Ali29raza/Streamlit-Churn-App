...
telecom_cust['TotalCharges'] = pd.to_numeric(telecom_cust['TotalCharges'], errors='coerce')  # it forcefully converts and replace nan with those which cant be converted
